package com.pratyushvkp.affinity.viewModel
...
import com.pratyushvkp.affinity.data.*
import com.pratyushvkp.affinity.ui.Gender
...
//        auth.signOut()
    ...
    fun onSignup(username: String, email: String, pass: String){
        if(username.isEmpty() or email.isEmpty() or pass.isEmpty()){
            handleException(customMessage = "Please fill in all credentials")
            return
        }
    ...
    private fun handleException(exception: Exception? = null, customMessage: String = ""){
        Log.e("Affinity", "App exception", exception)
