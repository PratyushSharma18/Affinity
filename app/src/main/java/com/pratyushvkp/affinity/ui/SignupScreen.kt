...
@Composable
fun SignupScreen(navController: NavController, vm: AffinityViewModel) {
   ...
   Box(modifier = Modifier.fillMaxSize()) {
       Column(modifier = Modifier
        ...
        Image(painter = painterResource(id = R.drawable.lovelogo), contentDescription = null,
        modifier = Modifier
            .width(200.dp)
            .padding(top = 16.dp)
            .padding(8.dp)
